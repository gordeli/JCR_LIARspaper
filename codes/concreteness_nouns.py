...
conn = sqlite3.connect('Liars7_nouns.sqlite') # The copy of the original database to use for iterating
...
shutil.copyfile('Liars7_nouns.sqlite', 'Liars7_w.sqlite')
...
for row in cur.execute(sqlstr):
    ...
    cur_w.execute('UPDATE Reviews SET Depth_N_rep_excl = ? WHERE id = ?', (review_depth_N_rep_excl, id, ))
    cur_w.execute('UPDATE Reviews SET N_rep_excl = ? WHERE id = ?', (N_rep_excl, id, ))
    cur_w.execute('UPDATE Reviews SET Depth_N_norep_excl = ? WHERE id = ?', (review_depth_N_norep_excl, id, ))
    cur_w.execute('UPDATE Reviews SET N_norep_excl = ? WHERE id = ?', (N_norep_excl, id, ))

    cur_w.execute('UPDATE Reviews SET Depth_V_rep_excl = ? WHERE id = ?', (review_depth_V_rep_excl, id, ))
    cur_w.execute('UPDATE Reviews SET V_rep_excl = ? WHERE id = ?', (V_rep_excl, id, ))
    cur_w.execute('UPDATE Reviews SET Depth_V_norep_excl = ? WHERE id = ?', (review_depth_V_norep_excl, id, ))
    cur_w.execute('UPDATE Reviews SET V_norep_excl = ? WHERE id = ?', (V_norep_excl, id, ))

    cur_w.execute('UPDATE Reviews SET Depth_J_rep_excl = ? WHERE id = ?', (review_depth_J_rep_excl, id, ))
    cur_w.execute('UPDATE Reviews SET J_rep_excl = ? WHERE id = ?', (J_rep_excl, id, ))
    cur_w.execute('UPDATE Reviews SET Depth_J_norep_excl = ? WHERE id = ?', (review_depth_J_norep_excl, id, ))
    cur_w.execute('UPDATE Reviews SET J_norep_excl = ? WHERE id = ?', (J_norep_excl, id, ))

    cur_w.execute('UPDATE Reviews SET Depth_R_rep_excl = ? WHERE id = ?', (review_depth_R_rep_excl, id, ))
    cur_w.execute('UPDATE Reviews SET R_rep_excl = ? WHERE id = ?', (R_rep_excl, id, ))
    cur_w.execute('UPDATE Reviews SET Depth_R_norep_excl = ? WHERE id = ?', (review_depth_R_norep_excl, id, ))
    cur_w.execute('UPDATE Reviews SET R_norep_excl = ? WHERE id = ?', (R_norep_excl, id, ))
...
shutil.copyfile('Liars7_w.sqlite', 'Liars7_hypnum.sqlite')
