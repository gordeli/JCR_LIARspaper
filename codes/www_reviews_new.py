...
def www_sent(sentence):
    ...
    conn_sent = sqlite3.connect('Liars7_www_sent_new.sqlite') # The copy of the original database to use for iterating
    # # Get the cursor, which is used to traverse the database, line by line
    cur_sent = conn_sent.cursor()
    sqlstr = "SELECT WC_LIWC, space_LIWC, time_LIWC, WWW_ST, WWW_ST_pairs, Space_emb, Time_emb, WWW_ST_emb FROM Sentences_raw WHERE Sentence = ?"
...
shutil.copyfile('Liars7_www_sent_new.sqlite', 'Liars7_w.sqlite') # we need to create an extra database to use it to generate another search query, because we will need a nested loop (a loop with a subloop)
conn = sqlite3.connect('Liars7_www_sent_new.sqlite')
cur = conn.cursor()
...
try:
    cur_w.execute('''ALTER TABLE Reviews ADD Space_sent_raw INTEGER NOT NULL DEFAULT 0''') # TF-er is the originally calculated value wich colculated the sum of numbers of unique nouns in each review  DEFAULT 0 was removed from the sql string
except:
    print("The column 'Space_sent_raw' exists already")
    pass # handle the error

try:
    cur_w.execute('''ALTER TABLE Reviews ADD Time_sent_raw INTEGER NOT NULL DEFAULT 0''') # TF-er is the originally calculated value wich colculated the sum of numbers of unique nouns in each review  DEFAULT 0 was removed from the sql string
except:
    print("The column 'Time_sent_raw' exists already")
    pass # handle the error

# try:
#     cur_w.execute('''ALTER TABLE Reviews ADD WWW_ST_raw INTEGER NOT NULL DEFAULT 0''') # TF-er is the originally calculated value wich colculated the sum of numbers of unique nouns in each review  DEFAULT 0 was removed from the sql string
# except:
#     print("The column 'WWW_ST_raw' exists already")
#     pass # handle the error

try:
    cur_w.execute('''ALTER TABLE Reviews ADD WWW_ST_sent_raw INTEGER NOT NULL DEFAULT 0''') # TF-er is the originally calculated value wich colculated the sum of numbers of unique nouns in each review  DEFAULT 0 was removed from the sql string
except:
    print("The column 'WWW_ST_sent_raw' exists already")
    pass # handle the error
...
try:
    cur_w.execute('''ALTER TABLE Reviews ADD WWW_ST_pairs_sent_raw INTEGER NOT NULL DEFAULT 0''') # TF-er is the originally calculated value wich colculated the sum of numbers of unique nouns in each review  DEFAULT 0 was removed from the sql string
except:
    print("The column 'WWW_ST_pairs_sent_raw' exists already")
    pass # handle the error

# try:
#     cur_w.execute('''ALTER TABLE Reviews ADD Space_emb INTEGER NOT NULL DEFAULT 0''') # TF-er is the originally calculated value wich colculated the sum of numbers of unique nouns in each review  DEFAULT 0 was removed from the sql string
# except:
#     print("The column 'Space_emb' exists already")
#     pass # handle the error

# try:
#     cur_w.execute('''ALTER TABLE Reviews ADD Time_emb INTEGER NOT NULL DEFAULT 0''') # TF-er is the originally calculated value wich colculated the sum of numbers of unique nouns in each review  DEFAULT 0 was removed from the sql string
# except:
#     print("The column 'Time_emb' exists already")
#     pass # handle the error

# try:
#     cur_w.execute('''ALTER TABLE Reviews ADD WWW_ST_emb INTEGER NOT NULL DEFAULT 0''') # TF-er is the originally calculated value wich colculated the sum of numbers of unique nouns in each review  DEFAULT 0 was removed from the sql string
# except:
#     print("The column 'WWW_ST_emb' exists already")
#     pass # handle the error

try:
    cur_w.execute('''ALTER TABLE Reviews ADD Space_emb_sent_raw INTEGER NOT NULL DEFAULT 0''') # TF-er is the originally calculated value wich colculated the sum of numbers of unique nouns in each review  DEFAULT 0 was removed from the sql string
except:
    print("The column 'Space_emb_sent_raw' exists already")
    pass # handle the error

try:
    cur_w.execute('''ALTER TABLE Reviews ADD Time_emb_sent_raw INTEGER NOT NULL DEFAULT 0''') # TF-er is the originally calculated value wich colculated the sum of numbers of unique nouns in each review  DEFAULT 0 was removed from the sql string
except:
    print("The column 'Time_emb_sent_raw' exists already")
    pass # handle the error

try:
    cur_w.execute('''ALTER TABLE Reviews ADD WWW_ST_emb_sent_raw INTEGER NOT NULL DEFAULT 0''') # TF-er is the originally calculated value wich colculated the sum of numbers of unique nouns in each review  DEFAULT 0 was removed from the sql string
except:
    print("The column 'WWW_ST_emb_sent_raw' exists already")
    pass # handle the error
...
sqlstr = 'SELECT id, WC_LIWC, space_LIWC, time_LIWC, percept_LIWC, cause_LIWC, Review FROM Reviews'
for row in cur.execute(sqlstr):
    ...
    cur_w.execute('UPDATE Reviews SET Space_sent_raw = ?, Time_sent_raw = ?, WWW_ST_sent_raw = ?, WWW_ST_pairs_sent_raw = ?,  Space_emb_sent_raw = ?, Time_emb_sent_raw = ?, WWW_ST_emb_sent_raw = ? WHERE id = ?', (space_sent, time_sent, www_ST_sent, www_pairs_sent, space_emb_sent, time_emb_sent, www_emb_sent, prmr_id, ))
...
shutil.copyfile('Liars7_w.sqlite', 'Liars7_www_new.sqlite')
