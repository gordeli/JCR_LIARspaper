...
conn = sqlite3.connect('yelp_clean_tr20210126.sqlite')
...
shutil.copyfile('yelp_clean_tr20210126.sqlite', 'Liars7_w.sqlite')
...
if len(name) < 1 : name = "Concreteness_ratings_Brysbaert_et_al_BRM.xls"
...
sqlstr = 'SELECT id, Review_cleaned FROM yelp_zip'
...
cur.close()
conn.close()
shutil.copyfile('Liars7_w.sqlite', 'yelp_wordforms.sqlite')
