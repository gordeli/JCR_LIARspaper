...
def process_row(row):
    ...
    if condition == 0:
        ...
        # [review_depth_N_rep_excl, N_rep_excl] = text_depth(reviewtext, ['NN', 'CD'], True, exclusion_list_fake)
        # [review_depth_N_norep_excl, N_norep_excl] = text_depth(reviewtext, ['NN', 'CD'], False, exclusion_list_fake)
        # [review_depth_V_rep_excl, V_rep_excl] = text_depth(reviewtext, 'VB', True, exclusion_list_fake)
        # [review_depth_V_norep_excl, V_norep_excl] = text_depth(reviewtext, 'VB', False, exclusion_list_fake)
        # [review_depth_J_rep_excl, J_rep_excl] = text_depth(reviewtext, 'JJ', True, exclusion_list_fake)
        # [review_depth_J_norep_excl, J_norep_excl] = text_depth(reviewtext, 'JJ', False, exclusion_list_fake)
        # [review_depth_R_rep_excl, R_rep_excl] = text_depth(reviewtext, 'RB', True, exclusion_list_fake)
        # [review_depth_R_norep_excl, R_norep_excl] = text_depth(reviewtext, 'RB', False, exclusion_list_fake)
        ...
        [review_depth_R_rep, R_rep] = text_depth(reviewtext, 'RB', True, [])
        [review_depth_R_norep, R_norep] = text_depth(reviewtext, 'RB', False, [])
        # [review_depth_N_rep_excl, N_rep_excl] = text_depth(reviewtext, ['NN', 'CD'], True, exclusion_list_real)
        # [review_depth_N_norep_excl, N_norep_excl] = text_depth(reviewtext, ['NN', 'CD'], False, exclusion_list_real)
        # [review_depth_V_rep_excl, V_rep_excl] = text_depth(reviewtext, 'VB', True, exclusion_list_real)
        # [review_depth_V_norep_excl, V_norep_excl] = text_depth(reviewtext, 'VB', False, exclusion_list_real)
        # [review_depth_J_rep_excl, J_rep_excl] = text_depth(reviewtext, 'JJ', True, exclusion_list_real)
        # [review_depth_J_norep_excl, J_norep_excl] = text_depth(reviewtext, 'JJ', False, exclusion_list_real)
        # [review_depth_R_rep_excl, R_rep_excl] = text_depth(reviewtext, 'RB', True, exclusion_list_real)
        # [review_depth_R_norep_excl, R_norep_excl] = text_depth(reviewtext, 'RB', False, exclusion_list_real)
    ...
    # return  (id, word_count, review_depth_N_rep, N_rep, review_depth_N_norep, N_norep, review_depth_V_rep, V_rep, review_depth_V_norep, V_norep, review_depth_J_rep, J_rep, review_depth_J_norep, J_norep, review_depth_R_rep, R_rep, review_depth_R_norep, R_norep, review_depth_N_rep_excl, N_rep_excl, review_depth_N_norep_excl, N_norep_excl, review_depth_V_rep_excl, V_rep_excl, review_depth_V_norep_excl, V_norep_excl, review_depth_J_rep_excl, J_rep_excl, review_depth_J_norep_excl, J_norep_excl, review_depth_R_rep_excl, R_rep_excl, review_depth_R_norep_excl, R_norep_excl)
...
def record_answers(cur, answers):
    ...
    for answer in answers:
        ...
        # id, word_count, review_depth_N_rep, N_rep, review_depth_N_norep, N_norep, review_depth_V_rep, V_rep, review_depth_V_norep, V_norep, review_depth_J_rep, J_rep, review_depth_J_norep, J_norep, review_depth_R_rep, R_rep, review_depth_R_norep, R_norep, review_depth_N_rep_excl, N_rep_excl, review_depth_N_norep_excl, N_norep_excl, review_depth_V_rep_excl, V_rep_excl, review_depth_V_norep_excl, V_norep_excl, review_depth_J_rep_excl, J_rep_excl, review_depth_J_norep_excl, J_norep_excl, review_depth_R_rep_excl, R_rep_excl, review_depth_R_norep_excl, R_norep_excl = answer
        ...
        # curr.execute('''INSERT OR IGNORE INTO Nouns (TF) VALUES (?)''', (count,))

        # curr.execute('UPDATE Reviews SET Depth_N_rep_excl = ? WHERE id = ?', (review_depth_N_rep_excl, id, ))
        # curr.execute('UPDATE Reviews SET N_rep_excl = ? WHERE id = ?', (N_rep_excl, id, ))
        # curr.execute('UPDATE Reviews SET Depth_N_norep_excl = ? WHERE id = ?', (review_depth_N_norep_excl, id, ))
        # curr.execute('UPDATE Reviews SET N_norep_excl = ? WHERE id = ?', (N_norep_excl, id, ))
        #
        # curr.execute('UPDATE Reviews SET Depth_V_rep_excl = ? WHERE id = ?', (review_depth_V_rep_excl, id, ))
        # curr.execute('UPDATE Reviews SET V_rep_excl = ? WHERE id = ?', (V_rep_excl, id, ))
        # curr.execute('UPDATE Reviews SET Depth_V_norep_excl = ? WHERE id = ?', (review_depth_V_norep_excl, id, ))
        # curr.execute('UPDATE Reviews SET V_norep_excl = ? WHERE id = ?', (V_norep_excl, id, ))
        #
        # curr.execute('UPDATE Reviews SET Depth_J_rep_excl = ? WHERE id = ?', (review_depth_J_rep_excl, id, ))
        # curr.execute('UPDATE Reviews SET J_rep_excl = ? WHERE id = ?', (J_rep_excl, id, ))
        # curr.execute('UPDATE Reviews SET Depth_J_norep_excl = ? WHERE id = ?', (review_depth_J_norep_excl, id, ))
        # curr.execute('UPDATE Reviews SET J_norep_excl = ? WHERE id = ?', (J_norep_excl, id, ))
        #
        # curr.execute('UPDATE Reviews SET Depth_R_rep_excl = ? WHERE id = ?', (review_depth_R_rep_excl, id, ))
        # curr.execute('UPDATE Reviews SET R_rep_excl = ? WHERE id = ?', (R_rep_excl, id, ))
        # curr.execute('UPDATE Reviews SET Depth_R_norep_excl = ? WHERE id = ?', (review_depth_R_norep_excl, id, ))
        # curr.execute('UPDATE Reviews SET R_norep_excl = ? WHERE id = ?', (R_norep_excl, id, ))
...
if __name__ == '__main__':
    ...
    conn = sqlite3.connect('Liars7_nouns20210128.sqlite') # The copy of the original database to use for iterating
    ...
    shutil.copyfile('Liars7_nouns20210128.sqlite', 'Liars7_w.sqlite')
    conn_w = sqlite3.connect('Liars7_w.sqlite') # The database to be updated
    cur_w = conn_w.cursor()

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Word_count INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
    ...
    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Depth_N_rep REAL DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'Depth_N_rep' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD N_rep INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'N_rep' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Depth_N_norep REAL DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'Depth_N_norep' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD N_norep INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'N_norep' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Depth_V_rep REAL DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'Depth_V_rep' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD V_rep INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'V_rep' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Depth_V_norep REAL DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'Depth_V_norep' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD V_norep INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'V_norep' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Depth_J_rep REAL DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'Depth_J_rep' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD J_rep INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'J_rep' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Depth_J_norep REAL DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'Depth_J_norep' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD J_norep INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'J_norep' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Depth_R_rep REAL DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'Depth_R_rep' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD R_rep INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'R_rep' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Depth_R_norep REAL DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'Depth_R_norep' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD R_norep INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'R_norep' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Depth_N_rep_excl REAL DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'Depth_N_rep_excl' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD N_rep_excl INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'N_rep_excl' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Depth_N_norep_excl REAL DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'Depth_N_norep_excl' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD N_norep_excl INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'N_norep_excl' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Depth_V_rep_excl REAL DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'Depth_V_rep_excl' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD V_rep_excl INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'V_rep_excl' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Depth_V_norep_excl REAL DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'Depth_V_norep_excl' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD V_norep_excl INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'V_norep_excl' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Depth_J_rep_excl REAL DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'Depth_J_rep_excl' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD J_rep_excl INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'J_rep_excl' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Depth_J_norep_excl REAL DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'Depth_J_norep_excl' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD J_norep_excl INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'J_norep_excl' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Depth_R_rep_excl REAL DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'Depth_R_rep_excl' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD R_rep_excl INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'R_rep_excl' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD Depth_R_norep_excl REAL DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
        print('''The column 'Depth_R_norep_excl' exists already''')
        pass # handle the error

    try:
        cur_w.execute('''ALTER TABLE Reviews ADD R_norep_excl INTEGER DEFAULT 0''') # DEFAULT 0 was removed from the sql string
    except:
    ...
    # print(len(exclusion_list_real), 'Nouns exclusion list for the real condition: ', exclusion_list_real)
    ...
    shutil.copyfile('Liars7_w.sqlite', 'Liars7_hypnum20210128_test.sqlite')
